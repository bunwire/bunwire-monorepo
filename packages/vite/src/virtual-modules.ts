...
export const BUNWIRE_PAGES_MODULE_ID = `${BUNWIRE_VIRTUAL_MODULE_PREFIX}pages` as const;
...
export const BUNWIRE_RESOLVED_PAGES_MODULE_ID = `\0${BUNWIRE_PAGES_MODULE_ID}` as const;
